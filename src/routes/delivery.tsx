        ...
        <section className="grid gap-8 md:grid-cols-2">
          <div>
            ...
            <ol className="space-y-3 text-sm text-muted-foreground">
              <li>Вы оставляете заказ на сайте или пишете нам в мессенджер.</li>
              <li>Мы подтверждаем состав, дату и интервал доставки.</li>
              <li>Собираем букет и, если нужно, присылаем фото до отправки.</li>
              <li>Курьер связывается с получателем за 20–30 минут до вручения.</li>
            </ol>
          </div>
          <div>
