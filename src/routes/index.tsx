      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-2 md:items-center">
        ...
        <div>
          ...
          <p className="mt-4 leading-relaxed text-muted-foreground">
            ...
            семейная цветочная студия в Раменском.
          </p>
          <p className="mt-3 leading-relaxed text-muted-foreground">
            С 2021 года создаём букеты и композиции для важных моментов: встречаем весну, поздравляем
            с днём рождения, оформляем свадьбы и помогаем выразить самые нужные слова.
          </p>
          <p className="mt-3 leading-relaxed text-muted-foreground">
